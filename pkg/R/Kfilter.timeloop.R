`Kfilter.timeloop` <-
	function(   auc, au, ap,
		...
		assign("auc",  aperm(array(retval$auc,     c(ne,nm,nt+1)), c(3,1:2)), envir=pf); cat("auc assigned\n")
		assign("au",   aperm(array(retval$au,     c(ne,nm,nm,nt)), c(4,1:3)), envir=pf); cat("au assigned\n")
		assign("ap",   aperm(array(retval$ap,     c(ne,nm,nm,nt)), c(4,1:3)), envir=pf); cat("ap assigned\n")
		assign("Puc",  aperm(array(retval$Puc,    c(ne,ne,nm,nt)), c(4,1:3)), envir=pf); cat("Puc assigned\n")
		assign("Pu",   aperm(array(retval$Pu,  c(ne,ne,nm,nm,nt)), c(5,1:4)), envir=pf); cat("Pu assigned\n")
		assign("Pp",   aperm(array(retval$Pp,  c(ne,ne,nm,nm,nt)), c(5,1:4)), envir=pf); cat("Pp assigned\n")
